...
Many genes involved in nitrate nutrition have a high level of inter-plant variability for their expression. We decided to focus on *NRT2.1*, one of the main nitrate transporters, that has a high level of inter-plant gene expression variability and for which gene regulation is well known. This project aims at understanding how the level of *NRT2.1* gene expression inter-plant variability is controlled, when differences are established between plants and what are the consequences of this variability.   
