...
<div style="clear: both;">
  ...
  <div>
    <p> I am a molecular geneticist and work on the role and regulation of inter-plant variability. Genetically identical plants, grown in the same environment, still show phenotypic differences. This inter-plant variability has been observe for many phenotypes like plant size, flowering time but also for gene expression as well as proteins and metabolites abundance.</p>
  </div>
</div>
...
<img style="float: left;" src="images/Summary_projects.png" alt="" width="70%"/>  
Our research projects focus on identifying the factors that regulate inter-plant variability and exploring its functional role. You can find an overview of the ongoing projects in [this seminar](https://www.youtube.com/watch?v=31X57xWZ0iE). We currently have 3 projects ongoing.
